...
const pricingPlans: Plan[] = [
  { id: 'starter', name: 'Audit', subtitle: 'Publisher audit & strategy' },
  { id: 'pro', name: 'Managed', subtitle: 'Ongoing AdOps support' },
  { id: 'business', name: 'Partnership', subtitle: 'Full-service monetisation' },
];
...
const pricingPlanData: Record<PlanId, PlanData> = {
  starter: {
    ...
    activeCount: 4,
    description:
      'A comprehensive audit of your publisher monetisation setup, covering revenue, viewability, fill rate, inventory, and GAM configuration — with a clear action plan.',
  },
  pro: {
    monthly: 149000,
    yearly: 1490000,
    activeCount: 7,
    description:
      'Ongoing AdOps support including campaign management, GAM operations, reporting, troubleshooting, and continuous yield optimisation for growing publishers.',
  },
  business: {
    monthly: 299000,
    yearly: 2990000,
    activeCount: 9,
    description:
      'Full-service monetisation partnership — strategy, AdOps, technical support, programmatic direct, and continuous improvement across your entire advertising ecosystem.',
  },
};

const includedItems: string[] = [
  'Publisher monetisation audit',
  'Revenue opportunity analysis',
  'Google Ad Manager review',
  'Viewability & fill rate analysis',
  'AdOps campaign management',
          ...
          <div className="space-y-8">
            <div className="space-y-5 text-center">
              <RevealAnimation delay={0.1}>
                <BadgePrimary>Service Packages</BadgePrimary>
              </RevealAnimation>

              <div className="space-y-3">
                <TextReveal delay={0.2}>
                  <h2>Publisher Services That Match Your Stage.</h2>
                </TextReveal>
                <TextReveal delay={0.3}>
                  <p className="text-background-14/60 mx-auto max-w-[600px]">
                    Whether you need a one-time audit or ongoing full-service support, Aeli AdOps
                    has a package built around your publisher monetisation needs.
                  </p>
                </TextReveal>
              </div>
            </div>
