...
import { fadeUp, scaleReveal, staggerContainer, staggerItem } from '@/src/components/animation/motion-variants';
      ...
      <div className="main-container relative z-10">
        <div className="space-y-9 text-center md:space-y-18">
          <div className="space-y-8 md:space-y-[70px]">
              ...
              <div className="mx-auto flex max-w-[254px] items-center justify-center gap-x-3">
                ...
                <RevealAnimation delay={0.2} direction="right" offset={50} instant>
                  <p className="text-tagline-2 text-background-14/80 mx-auto max-w-[142px] shrink-0 text-left">
                    <CounterNumberOnScroll value={500} delay={0.4} />+ publishers growing their revenue.
                  </p>
                </RevealAnimation>
              </div>
              <motion.div
                ...
                className="space-y-4"
              >
                <motion.h1 variants={fadeUp} className="mx-auto max-w-[950px]">
                  Helping Publishers Grow Their Ad Revenue
                </motion.h1>
                <motion.p variants={fadeUp} className="mx-auto max-w-[620px]">
                  We help publishers improve their advertising performance through Google Ad Manager, Ad Operations, Yield Optimization, and technical support. Our goal is simple—help you get the most value from every impression.
                </motion.p>
              </motion.div>
            </div>
            ...
            >
              <motion.div variants={staggerItem} className="w-[70%] md:w-auto">
              ...
              <motion.div variants={staggerItem} className="w-[70%] md:w-auto">
                <Link href="/publisher-audit" className="w-full md:w-auto">
                  <ButtonSecondary
          ...
          >
            <Image src={heroBanner} alt="hero-banner-img" className="size-full object-cover object-top" priority />
          </motion.figure>
        </div>
