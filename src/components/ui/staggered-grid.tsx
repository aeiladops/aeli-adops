    ...
    return (
        ...
        >
            <section className="grid place-items-center w-full relative mt-[10vh]">
                <div ref={textRef} className="text font-alt uppercase flex content-center text-[clamp(3rem,14vw,10rem)] leading-[0.7] text-background-14">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className={cn(
                                                    ...
                                                    isActive
                                                        ? "border-stroke-1"
                                                        : "border-stroke-2 group-hover:border-stroke-1"
                                                )} />
                                                ...
                                                <div className="relative z-10 w-full h-full flex flex-col p-0">
                                                    ...
                                                    <div className={cn(
                                                        ...
                                                        {/* Image - Full Coverage */}
                                                        <div className="absolute inset-0 bg-background-3 overflow-hidden z-0 group/img">
                                                            {bentoItem.image && (
                                                                <>
                                                                    <img
                                                                        src={bentoItem.image}
                                                                    ...
                                                                    <div className="absolute bottom-0 left-0 w-full h-40 bg-gradient-to-t from-white via-white/50 to-transparent pointer-events-none" />
                                                                </>
                                                            )}
                                                        </div>
                                                        ...
                                                        <div className="absolute bottom-0 left-0 w-full h-20 flex items-center justify-between px-5 z-20">
                                                            <div className="flex flex-col relative z-10">
                                                                <h3 className="text-sm font-bold text-background-14 drop-shadow-md leading-none tracking-tight">{bentoItem.title}</h3>
                                                            </div>
                                                            <div className="text-background-14/90 transition-colors hover:text-background-14 drop-shadow-md relative z-10">
                                                                {bentoItem.icon}
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className={cn(
                                                    ...
                                                    <div className="text-background-14/50 group-hover:text-background-14 transition-colors">
                                                        {bentoItem.icon}
                                                    </div>
                                                    <span className="text-[10px] font-medium text-background-14/60 group-hover:text-background-14/80 transition-colors uppercase tracking-wider">{bentoItem.title}</span>
                                                </div>
                                            </div>
                                        )
                                    })}
                        ...
                        if (typeof item === 'string') {
                            ...
                            return (
                                <figure key={`img-${i}`} data-col={i % 7} className="grid__item m-0 relative z-10 [perspective:800px] will-change-[transform,opacity] group cursor-pointer">
                                    <div className="grid__item-img w-full h-full [backface-visibility:hidden] will-change-transform rounded-xl overflow-hidden shadow-sm border border-stroke-2 bg-background-1 flex items-center justify-center transition-all duration-500 ease-out group-hover:scale-105 group-hover:shadow-xl group-hover:border-transparent">

                                        {/* Gradient Overlay for Hover */}
                                        <div className="absolute inset-0 bg-gradient-to-b from-primary-600/40 via-primary-700/80 to-primary-800 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0" />

                                        {/* Content Container */}
                                        <div className="relative z-10 flex flex-col items-center justify-center gap-3">
                                            {/* Icon */}
                                            <Icon className="w-8 h-8 text-background-14/40 transition-all duration-300 group-hover:text-white group-hover:scale-110" />
            ...
            {showFooter && (
                <footer className="frame__footer w-full p-8 flex justify-between items-center relative z-50 text-background-14 uppercase font-medium text-xs tracking-wider">
