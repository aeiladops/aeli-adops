...
import benefitRoiImg from '@/public/images/aeli-why-choose-1.png';
...
export const BenefitRoiCard = ({ className, ...props }: BenefitRoiCardProps) => {
  return (
    <div
      className={cn(
        'relative flex h-[350px] flex-col items-center justify-end overflow-hidden rounded-[20px] bg-white p-6 md:h-[550px]',
        className
      )}
      {...props}
    >
