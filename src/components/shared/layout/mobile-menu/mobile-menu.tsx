      ...
      <div className="space-y-4 p-5 sm:p-8 lg:p-9">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3" onClick={closeMenu}>
            ...
            <figure className="relative size-10 overflow-hidden rounded-full ring-2 ring-primary-500/20 shadow-sm">
              <Image src={logo} alt="Aeli AdOps" fill className="object-cover" />
            </figure>
            <span className="font-extrabold text-base tracking-tight text-secondary">
              Aeli AdOps
            </span>
          </Link>
          <MenuCloseButton />
